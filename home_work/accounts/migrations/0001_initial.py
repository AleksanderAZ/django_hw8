    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profile_picts/')),
                ('is_active', models.BooleanField(default=True, verbose_name='Активний')),
                ('is_staff', models.BooleanField(default=True, verbose_name='Персонал')),
                ('date_joined', models.DateField(default=django.utils.timezone.now, verbose_name='Дата реєстрації')),
            ...
            options={
                ...
                'permissions': [('can_view_profiles', 'Переглядати профілі інших'), ('can_edit_profiles', 'Редагувати профілі інших')],
            },
        ),
        migrations.CreateModel(
            name='UserAdress',
